...
<head>
  ...
  <meta http-equiv="Content-Security-Policy" content="default-src 'self'; script-src 'self' 'unsafe-eval' https://cdnjs.cloudflare.com; style-src 'self' 'unsafe-inline' https://fonts.googleapis.com; font-src 'self' https://fonts.gstatic.com;">
...
<body class="front-page">
      ...
      <div class="swiper features-slider">
        ...
        <ul class="swiper-wrapper header-features">
          ...
          <li class="swiper-slide header-features-item">
            ...
            <p class="header-featuress-text">Вся продукция сертифицирована</p>
          </li>
          <li class="swiper-slide header-features-item">
            <svg width="36" height="36">
          ...
          <li class="swiper-slide header-features-item">
            ...
            <p class="header-featuress-text">Оперативное производство</p>
          </li>
        </ul>
    ...
    <div class="container">
      ...
      <div class="cards">
        <a href="./avto-him.php" class="card">
          ...
          <!-- /.card-content -->
          <img src="img/autohim.png" alt="Автомобильная химия" class="card-image" />
        </a href="#">
        <a href="#" class="card">
          <div class="card-content">
        ...
        <a href="#" class="card">
          ...
          <img src="img/autohim.png" alt="Пищевые аэрозоли" class="card-image" />
        </a href="#">
        <a href="#" class="card">
          <div class="card-content">
        ...
        <a href="#" class="card">
          ...
          <img src="img/dezinfect.png" alt="Краски аэрозольные" class="card-image" />
        </a href="#">
      </div>
    </div>
  </section>
  <section class="section trademark">
    <div class="container">
      ...
      <div class="trademark-cards">
        <a href="/ag-tech.html" class="trademark-card">
  ...
  <section class="section founder">
    <img src="img/founder.jpg" alt="founder photo" class="founder-photo">
    <div class="container">
